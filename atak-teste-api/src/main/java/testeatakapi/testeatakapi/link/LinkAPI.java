...
public class LinkAPI {
    ...
    onde termo_de_pesquisa é o termo que deseja pesquisar no Google.
    Isso vai acionar o processo de extração de links do Google e vai salvar no banco de dados.
     */
